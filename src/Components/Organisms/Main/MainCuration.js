      ...
      <div className="mainCuration">
        ...
        <div className="curationPoster">
          ...
          <div className="curationComment">
            ...
            <h3>야구소녀</h3>
            <br />
            <p className="storySummary">
              “사람들이 내 미래를 어떻게 알아요? 나도 모르는데…”
            </p>
            <br />
            <br />
            <p>
              최고구속 134km, 볼 회전력의 강점으로 ‘천재 야구소녀’라는 별명을
              얻으며 주목받았던 ‘주수인’(이주영). 고교 졸업 후 오로지 프로팀에
              입단해 계속해서 야구를 하는 것이 꿈이지만 여자라는 이유로 제대로
              된 평가도 기회도 잡지 못한다. 엄마, 친구, 감독까지 모두가 꿈을
              포기하라고 할 때, 야구부에 새로운 코치 ‘진태’(이준혁)가 부임하고
              수인에게도 큰 변화가 찾아오는데…
            </p>
            <div className="posterWrap">
              <figure>
                <img
                  src="https://img.megabox.co.kr/SharedImg/2020/06/23/4jr7i0mDwxOpILVarLlS05gmjZt8GiPp_230.jpg"
                  alt="[시네도슨트] 빈센트 반 고흐 미술관&amp;크롤러 뮐러 미술관"
                />
                <figcaption>
                  [시네도슨트] 빈센트 반 고흐 미술관&amp;크롤러 뮐러 미술관
                </figcaption>
              </figure>
              <figure>
                <img
